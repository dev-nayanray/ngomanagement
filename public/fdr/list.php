...
// Fetch all FDR records
$fdrRecords = $conn->query("SELECT * FROM FDR");
?>

<div class="container mx-auto mt-5">
    <h1 class="text-3xl font-bold mb-4">FDR List</h1>
    <a href="add.php" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">Add New FDR</a>
    <table class="w-full table-auto">
        ...
        <tbody>
            <?php while ($row = $fdrRecords->fetch_assoc()): ?>
            <tr>
