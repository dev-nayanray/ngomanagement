...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $savingsController->addSavings($member_id, $amount, $date);
    header("Location: list.php");
}
?>

<div class="container mx-auto mt-5">
    <h1 class="text-3xl font-bold mb-4">Add New Savings</h1>
    <form method="POST" action="add.php">
        ...
        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Add Savings</button>
    </form>
</div>
