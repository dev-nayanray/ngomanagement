...
$investmentRecords = $conn->query("SELECT * FROM Investments");
?>

<div class="container mx-auto mt-5">
    <h1 class="text-3xl font-bold mb-4">Investment List</h1>
    <a href="add.php" class="bg-blue-500 text-white px-4 py-2 rounded mb-4 inline-block">Add New Investment</a>
    <table class="w-full table-auto">
        ...
        <tbody>
            <?php while ($row = $investmentRecords->fetch_assoc()): ?>
            <tr>
