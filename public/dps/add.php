...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $dpsController->addDPS($member_id, $scheme, $start_date, $maturity_date, $amount);
    header("Location: list.php");
}
?>

<div class="container mx-auto mt-5">
    <h1 class="text-3xl font-bold mb-4">Add New DPS</h1>
    <form method="POST" action="add.php">
        ...
        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded">Add DPS</button>
    </form>
</div>
